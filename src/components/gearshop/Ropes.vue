      ...
      <div class="whitepanel">
        ...
        <div class="product__container">
          <v-card v-for="(rope, i) in getGear" :key="i" class="mx-auto card" max-width="250">
            <v-img :src="rope.itemPicture" height="200px" :alt="rope.itemName"></v-img>
            ...
            <div class="counter">
              <v-btn
                :id="rope.id"
                :disabled="rope.count <= 1 ? !disabled : disabled"
...
export default {
  ...
  data() {
    return { disabled: false, product: "ropes" };
  },
  components: {
    navbar: NavBar,
    footerComp: Footer,
