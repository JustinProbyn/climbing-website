      ...
      <div class="whitepanel">
        ...
        <div class="product__container">
          <v-card v-for="(quickdraw, i) in getGear" :key="i" class="mx-auto card" max-width="250">
            <v-img :src="quickdraw.itemPicture" height="200px" :alt="quickdraw.itemName"></v-img>
            ...
            <div class="counter">
              <v-btn
                :id="quickdraw.id"
                :disabled="quickdraw.count <= 1 ? !disabled : disabled"
...
export default {
  ...
  data() {
    return { disabled: false, product: "quickdraws" };
  },
  components: {
    navbar: NavBar,
    footerComp: Footer,
...
.quickdraws__header .pictures__nav {
  float: right;
  font-size: 200%;
}
